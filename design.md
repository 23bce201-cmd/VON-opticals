...
*  **Background**: `#FFFFFF` (Pure White) - Primary canvas and main surfaces.
*  **Foreground**: `#000000` (Pure Black) - Primary text, headings, and high-contrast content.
*  **Muted**: `#F2F2F2` (Light Gray) - Secondary surfaces, cards, input backgrounds, and visual separation.
*  **Accent**: `#2563C7` (Von Blue) - Brand color used for CTAs, links, active states, selected elements, and important emphasis.
*  **Border**: `#000000` (Pure Black) - Structural borders, dividers, and component outlines.
